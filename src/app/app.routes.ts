...
import { InvoiceComponent } from "./pages/sales/invoice/invoice.component";
    ...
    children: [
      {
        ...
        pathMatch: "full",
        title:
          "Supermercado Bocota | Punto de venta | Panel de Facturación y Ventas",
      },
      {
        path: "dashboard",
        component: EcommerceComponent,
        title:
          "Angular Dashboard Details Dashboard | TailAdmin - Angular Admin Dashboard Template",
      },
      {
        path: "cash/opening",
        component: EcommerceComponent,
